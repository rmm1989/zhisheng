...
<html>
  ...
  <body>
    <div class="x-body">
        <form action="{{url('admin/role/edit')}}" method="post" class="layui-form layui-form-pane">
            {{csrf_field()}}
                            ...
                            <tr>
                                <td>
                                    @if(in_array($v->id,$ids))
                                            {{$v->priv_name}}
                                            <input name="priv_id[]" type="checkbox" value="{{$v->id}}" checked="">
                                        @else
                                ...
                                <td>
                                    <div class="layui-input-block">
                                        ...
                                        <input name="priv_id[]" type="checkbox" value="{{$b->id}}" checked=""> {{$b->priv_name}}
                                                @else
