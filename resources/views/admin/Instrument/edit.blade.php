...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form layui-form-pane" enctype="multipart/form-data" action="{{url('admin/instrument/edit')}}" method="post">
            {{csrf_field()}}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="{{$info->brands}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="name" class="layui-form-label">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="serial_number" required="" lay-verify="required"
                               autocomplete="off" class="layui-input" value="{{$info->serial_number}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="name" class="layui-form-label">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="model_number" required="" lay-verify="required"
                               autocomplete="off" class="layui-input" value="{{$info->model_number}}">
                    </div>
                </div>
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="picture" autocomplete="off" class="layui-input" value="{{$info->picture}}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="security_deposit" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="{{$info->security_deposit}}">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="day_rent" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="{{$info->day_rent}}">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="power" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="{{$info->power}}">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="line" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="{{$info->line}}">
                </div>
            </div>
            <div class="layui-form-item">
